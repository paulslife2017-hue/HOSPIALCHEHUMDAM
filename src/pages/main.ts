...
'</script>\n' +
'<!-- Instagram 문의 플로팅 버튼 -->\n' +
'<a href="https://www.instagram.com/seoulbeautytrip_en/" target="_blank" rel="noopener"\n' +
'   style="position:fixed;bottom:28px;right:20px;z-index:999;display:flex;align-items:center;gap:8px;padding:11px 16px 11px 13px;border-radius:50px;text-decoration:none;color:#fff;font-size:13px;font-weight:600;box-shadow:0 4px 18px rgba(0,0,0,.18);background:linear-gradient(135deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888);transition:transform .2s,box-shadow .2s;" onmouseover="this.style.transform=\'translateY(-2px)\';this.style.boxShadow=\'0 8px 24px rgba(0,0,0,.22)\'" onmouseout="this.style.transform=\'none\';this.style.boxShadow=\'0 4px 18px rgba(0,0,0,.18)\'">\n' +

...
'\n' +
'      <!-- Requirements -->\n' +
'      <p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.08em;margin:0 0 8px;">✅ Requirements</p>\n' +
...
'          <div>\n' +
'            <p style="font-size:13px;font-weight:700;color:#92400e;margin:0 0 1px;">Minimum 3,000 Instagram followers</p>\n' +
'            <p style="font-size:11px;color:#a16207;margin:0;line-height:1.5;">Applications with fewer than 3,000 followers may not be accepted.</p>\n' +
'          </div>\n' +
'        </div>\n' +
...
'          <span style="font-size:20px;flex-shrink:0;margin-top:1px;">🎬</span>\n' +
'          <div>\n' +
'            <p style="font-size:13px;font-weight:700;color:#166534;margin:0 0 1px;">Review video upload is mandatory</p>\n' +
'            <p style="font-size:11px;color:#15803d;margin:0;line-height:1.5;">You must post a Reels or video review on Instagram after your visit.<br>Failure to upload may result in being excluded from future programs.</p>\n' +
'          </div>\n' +
'        </div>\n' +
...
'          <span style="font-size:20px;flex-shrink:0;margin-top:1px;">📅</span>\n' +
'          <div>\n' +
'            <p style="font-size:13px;font-weight:700;color:#991b1b;margin:0 0 1px;">Please honor your confirmed appointment</p>\n' +
'            <p style="font-size:11px;color:#b91c1c;margin:0;line-height:1.5;">No-shows or missed dates will result in being banned from all future programs.</p>\n' +
'          </div>\n' +
'        </div>\n' +
'      </div>\n' +
'\n' +
'      <!-- How it works -->\n' +
'      <p style="font-size:11px;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.08em;margin:0 0 8px;">📋 How It Works</p>\n' +
...
'          <p style="font-size:12px;color:#374151;margin:0;line-height:1.6;padding-top:2px;"><strong>Submit your application</strong> — Click the Apply button on any clinic you like</p>\n' +
'        </div>\n' +
'        <div style="display:flex;align-items:flex-start;gap:10px;padding:9px 0;border-bottom:1px solid #f3f4f6;">\n' +
...
'          <p style="font-size:12px;color:#374151;margin:0;line-height:1.6;padding-top:2px;"><strong>Clinic review</strong> — The clinic checks your Instagram profile</p>\n' +
'        </div>\n' +
'        <div style="display:flex;align-items:flex-start;gap:10px;padding:9px 0;border-bottom:1px solid #f3f4f6;">\n' +
...
'          <p style="font-size:12px;color:#374151;margin:0;line-height:1.6;padding-top:2px;"><strong>Contact via Instagram DM</strong> — If selected, the clinic will reach out to you directly via DM</p>\n' +
'        </div>\n' +
'        <div style="display:flex;align-items:flex-start;gap:10px;padding:9px 0;border-bottom:1px solid #f3f4f6;">\n' +
...
'          <p style="font-size:12px;color:#374151;margin:0;line-height:1.6;padding-top:2px;"><strong>Visit the clinic</strong> — Confirm your appointment date and time, then visit</p>\n' +
'        </div>\n' +
...
'          <p style="font-size:12px;color:#374151;margin:0;line-height:1.6;padding-top:2px;"><strong>Upload your review</strong> — Post your experience as a Reels or video on Instagram</p>\n' +
'        </div>\n' +
'      </div>\n' +
'\n' +
'      <!-- CTA Button -->\n' +
...
'        <button onclick="closeWelcomePopupForever()" style="background:none;border:none;font-size:11px;color:#9ca3af;cursor:pointer;text-decoration:underline;">Don\'t show again today</button>\n' +
'      </div>\n' +
'    </div>\n' +
'  </div>\n' +
'</div>\n' +
...
'      <strong style="color:#111827;">contact you directly via Instagram DM</strong> if selected.\n' +
'    </p>\n' +
'    <!-- 구분선 -->\n' +
...
'      Got it! 👍\n' +
'    </button>\n' +
'    <p style="font-size:11px;color:#d1d5db;margin:10px 0 0;">The clinic will reach out within a few days via Instagram DM.</p>\n' +
'  </div>\n' +
'</div>\n' +
'\n' +
'<!-- ═══ DETAIL MODAL ═══ -->\n' +
...
'   style="position:fixed;bottom:28px;right:20px;z-index:999;width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;text-decoration:none;box-shadow:0 4px 18px rgba(0,0,0,.22);background:linear-gradient(135deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888);transition:transform .2s,box-shadow .2s;" onmouseover="this.style.transform=\'translateY(-3px)\';this.style.boxShadow=\'0 8px 24px rgba(0,0,0,.28)\'" onmouseout="this.style.transform=\'none\';this.style.boxShadow=\'0 4px 18px rgba(0,0,0,.22)\'" title="Contact Us on Instagram">\n' +
'  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="white"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>\n' +
'</a>\n' +
'</body>\n' +
'</html>'
}
